...
public class AverageCapitalPlusInterestUtils {
    ...
    public static void main(String[] args) {
        double invest = 300000; // 本金
        int month = 24;
        double yearRate = 0.078; // 年利率
...
//        	System.out.println("第"+(i+1)+"期："+(mapInterest.get(i+1)));
        	System.out.println("第"+(i+1)+"期："+Math.ceil(mapInterest.get(i+1).doubleValue()));
        }
    }
}
